...
public abstract class ResourceOrganizer {
    ...
    public static void main(String[] args) throws Exception {
        ...
        for (File fi : f.listFiles()) {
            MODID = fi.getName();
            //delete(new File("./src/main/resources/assets/l2archery/"));
            delete(new File("./src/main/resources/data/l2archery/recipes"));
            if (!fi.isDirectory())
                continue;
    ...
    public final String getResourceFolder(boolean main) {
        return (main ? "./src/main/resources/" : "l2archery/src/test/resources/");
    }
