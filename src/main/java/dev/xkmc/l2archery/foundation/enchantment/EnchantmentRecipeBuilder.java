package dev.xkmc.l2archery.foundation.enchantment;
...
public class EnchantmentRecipeBuilder implements RecipeBuilder {
	...
	public void save(Consumer<FinishedRecipe> p_176499_) {
		this.save(p_176499_, new ResourceLocation(L2Archery.MODID, ForgeRegistries.ENCHANTMENTS.getKey(this.enchantment).getPath()));
	}
